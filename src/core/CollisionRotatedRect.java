...
public class CollisionRotatedRect extends CollisionBounds {
	...
	CollisionRotatedRect(Element data) {
		...
		cacheIsValid = false;
		Vector v = new Vector();
		corners = new Vector[]{v.copy(), v.copy(), v.copy(), v.copy()};
		axes = new Vector[]{v.copy(), v};
	}
	...
	protected boolean fullCollisionCheck(CollisionBounds other) {
		...
		if (other instanceof CollisionBox) {
			...
			otherCorners = new Vector[]{new Vector(otherX, otherY), new Vector(otherX + otherWidth, otherY), new Vector(otherX + otherWidth, otherY + otherHeight), new Vector(otherX, otherY + otherHeight)
			};
		} else {
